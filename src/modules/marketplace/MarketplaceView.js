            ...
            <div class="cinematic-hero-content">
              <div style="max-width: 640px;">
                ...
                <div style="display: flex; gap: 1.25rem; flex-wrap: wrap;">
                  <button id="hero-browse-btn" style="height: 50px; background: #00A1DE; border: none; color: #FFFFFF; font-weight: 800; font-size: 1.02rem; border-radius: 12px; padding: 0 32px; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 8px 25px rgba(0, 161, 222, 0.4);">
                    ${t('browse_products')}
                  </button>
